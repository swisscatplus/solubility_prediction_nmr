...
from analysis.analysis import count_over_under_estimation, count_incoherence_molecule, bar_plot_over_under_estimation, butterfly_plot_over_under_estimation, plot_ordered_solubility_array, analyze_plot_chemical_bias, plot_rt_ordered_solubility, plot_master_overlaid_multi_trends, plot_solvent_correlation_heatmap
...
def main():
    ...
    """analyze_plot_chemical_bias('/Users/arthurbenard/Project 1B/data/Compared_Results.xlsx','CHCl3')"""
