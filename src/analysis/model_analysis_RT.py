...
from controller.predictor_runner import generate_ml_ready_file_onehot_solvent
...
sys.stdout = open('output_no_logs.txt', 'w')
...
print(f"Matrix shape (without logS): {X_v2.shape}") # should be 2054 columns
...
plt.title('Avg Confusion Matrix (WITHOUT logS)')
plt.savefig('Confusion_Matrix_No_logS.png')
plt.close()
